...
// KEY CLASE: Service_index e7824eacb458dd094ea15650339708728e3eaf5a
// KEY METODO: Session_index   16081646915fdaa55a8a187
...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        url: "Api.php",
        headers : {
            "Class" : "e7824eacb458dd094ea15650339708728e3eaf5a",
            "Token-Metodo" :"16081646915fdaa55a8a187",
        },
        data: {URL},
        success: function (response) {
            let json = JSON.parse(response);
